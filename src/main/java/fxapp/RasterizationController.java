...
import triangle.TriangleRender;
...
//                canvas.getGraphicsContext2D());
        ...
        TriangleRender.drawTriangle(200, 210, Color.RED,
                210, 350, Color.BLUE,
                534.4f, 206.8f, new Color(0, 1, 0, 0),
                canvas.getGraphicsContext2D());
        TriangleRender.drawTriangle(520, 410, Color.RED,
                210, 350, Color.BLUE,
                534.4f, 206.8f, new Color(0, 1, 0, 0),
                canvas.getGraphicsContext2D());
    }
